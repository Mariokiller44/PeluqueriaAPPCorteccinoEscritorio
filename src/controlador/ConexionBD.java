...
public class ConexionBD implements Configuracion{
    ...
    private static String URL=Configuracion.URL; // Establecemos la URL de la base de datos a la predeterminada en la interfaz Configuracion.
